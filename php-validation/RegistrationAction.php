...
<head>
	...
	<title>PHPSelfFormValidation_19-41298-3</title>
</head>
<body>
	...
	<fieldset>
			<legend><b>Your Submitted Informations:</b></legend>
			<?php
...

				{
					...
					echo "Date of birth: ".$birthdaycheck;
					echo "<br><br>";

					echo "Permanent address: ".$peradd;
					echo "<br><br>";

					echo "Present address: ".$preadd;
					echo "<br><br>";
